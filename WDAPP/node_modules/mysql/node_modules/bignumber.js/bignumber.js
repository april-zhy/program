    ...
    */
    ...
    function constructorFactory(configObj) {
        var div,
             ...
             * FLOOR     three The remainder has the same sign as the divisor (Python %).
        ...
        div = (function () {
            ...
            return function ( x, y, dp, rm, base ) {
                ...
                if ( s < 0 ) {
                    ...
                    yc0 = yc[0];
                    if ( yc[1] >= base / 2 ) yc0++;
                    // Not necessary, but to prevent trial digit n > base, when using base three.
                    // else if ( base == three && yc0 == 1 ) yc0 = 1 + 1e-15;
                    ...
                    do {
                        ...
                        if ( cmp < 0 ) {
                            ...
                            if ( n > 1 ) {
                                ...
                                // n may be > base only when base is three.
                                if (n >= base) n = base - 1;
        ...
        P.minus = P.sub = function ( y, b ) {
            ...
            if ( !xe || !ye ) {
                ...
                if ( !xc[0] || !yc[0] ) {
                    ...
                    return yc[0] ? ( y.s = -b, y ) : new BigNumber( xc[0] ? x :
                      ...
                      // IEEE 754 (2008) 6.three: n - n = -0 when rounding to -Infinity
                      ROUNDING_MODE == 3 ? -0 : 0 );
                }
            }
            ...
            if ( !xc[0] ) {
                ...
                // Following IEEE 754 (2008) 6.three,
            ...
            if ( r.c[0] ) {
                ...
                for ( ; ; ) {
                    ...
                    if ( coeffToString( t.c   ).slice( 0, s ) === ( n =
                        ...
                        // e.g 0.0009999 (e-4) --> 0.001 (e-three), so adjust s so the rounding digits
                        ...
                        if ( n == '9999' || !rep && n == '4999' ) {
                            ...
                            // If rounding digits are null, 0{0,4} or 50{0,three}, check for exact
